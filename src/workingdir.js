...
function makeWorkingDir(getDb, config) {
  ...
  // Öffnet das Working-Dir in VS Code (Fallback: Finder via `open`).
  // execFile mit Args-Array → keine Shell-Interpolation, keine Injection.
  function openWorkingDir(taskId) {
    ...
    execFile('code', [task.working_dir], (err) => {
